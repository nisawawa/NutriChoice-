export const CRITERIA = [
  { id: 'C1', name: 'Protein', weight: 0.25, type: 'benefit' },
  { id: 'C2', name: 'Serat', weight: 0.20, type: 'benefit' },
  { id: 'C3', name: 'Vitamin', weight: 0.15, type: 'benefit' },
  { id: 'C4', name: 'Harga', weight: 0.15, type: 'cost' },
  { id: 'C5', name: 'Kalori', weight: 0.10, type: 'cost' },
  { id: 'C6', name: 'Lemak Jenuh', weight: 0.10, type: 'cost' },
  { id: 'C7', name: 'Natrium', weight: 0.05, type: 'cost' }
];
...
// Original Raw Ingredients for the Table
export const ALTERNATIVES = [
  { id: 'A1', name: 'Oatmeal', emoji: '🥣', values: { C1: 6, C2: 10, C3: 8, C4: 6, C5: 7, C6: 2, C7: 1 } },
  { id: 'A2', name: 'Tempe', emoji: '🍘', values: { C1: 9, C2: 8, C3: 7, C4: 4, C5: 6, C6: 3, C7: 4 } },
  { id: 'A3', name: 'Brokoli', emoji: '🥦', values: { C1: 10, C2: 9, C3: 10, C4: 7, C5: 7, C6: 2, C7: 5 } },
  { id: 'A4', name: 'Bayam', emoji: '🥬', values: { C1: 4, C2: 8, C3: 10, C4: 3, C5: 4, C6: 1, C7: 3 } },
  { id: 'A5', name: 'Salmon', emoji: '🐟', values: { C1: 10, C2: 2, C3: 8, C4: 10, C5: 8, C6: 4, C7: 4 } },
  { id: 'A6', name: 'Dada Ayam', emoji: '🍗', values: { C1: 9, C2: 7, C3: 8, C4: 6, C5: 5, C6: 2, C7: 3 } },
  { id: 'A7', name: 'Almond', emoji: '🥜', values: { C1: 5, C2: 8, C3: 9, C4: 7, C5: 6, C6: 3, C7: 1 } },
  { id: 'A8', name: 'Quinoa', emoji: '🍚', values: { C1: 8, C2: 9, C3: 8, C4: 8, C5: 7, C6: 2, C7: 4 } },
  { id: 'A9', name: 'Tahu', emoji: '🧊', values: { C1: 6, C2: 7, C3: 8, C4: 5, C5: 5, C6: 2, C7: 5 } },
  { id: 'A10', name: 'Alpukat', emoji: '🥑', values: { C1: 5, C2: 9, C3: 8, C4: 7, C5: 7, C6: 3, C7: 2 } },
  { id: 'A11', name: 'Apel', emoji: '🍎', values: { C1: 4, C2: 8, C3: 9, C4: 8, C5: 6, C6: 2, C7: 1 } },
  { id: 'A12', name: 'Pisang', emoji: '🍌', values: { C1: 5, C2: 7, C3: 7, C4: 5, C5: 6, C6: 2, C7: 2 } },
  { id: 'A13', name: 'Kacang Hitam', emoji: '🫘', values: { C1: 8, C2: 9, C3: 7, C4: 6, C5: 6, C6: 1, C7: 4 } },
  { id: 'A14', name: 'Wortel', emoji: '🥕', values: { C1: 3, C2: 7, C3: 10, C4: 5, C5: 4, C6: 1, C7: 3 } },
  { id: 'A15', name: 'Bawang Putih', emoji: '🧄', values: { C1: 9, C2: 2, C3: 7, C4: 6, C5: 7, C6: 3, C7: 3 } },
  { id: 'A16', name: 'Blueberry', emoji: '🫐', values: { C1: 6, C2: 6, C3: 9, C4: 7, C5: 5, C6: 2, C7: 2 } },
  { id: 'A17', name: 'Telur Rebus', emoji: '🥚', values: { C1: 7, C2: 5, C3: 7, C4: 4, C5: 6, C6: 3, C7: 4 } },
  { id: 'A18', name: 'Yogurt', emoji: '🥛', values: { C1: 8, C2: 4, C3: 8, C4: 7, C5: 5, C6: 2, C7: 2 } },
  { id: 'A19', name: 'Edamame', emoji: '🫛', values: { C1: 7, C2: 7, C3: 6, C4: 5, C5: 5, C6: 1, C7: 3 } },
  { id: 'A20', name: 'Minyak Zaitun', emoji: '🫒', values: { C1: 4, C2: 6, C3: 5, C4: 6, C5: 7, C6: 2, C7: 4 } },
  { id: 'A21', name: 'Ubi Jalar', emoji: '🍠', values: { C1: 2, C2: 7, C3: 9, C4: 4, C5: 6, C6: 1, C7: 1 } },
  { id: 'A22', name: 'Jeruk', emoji: '🍊', values: { C1: 2, C2: 6, C3: 10, C4: 5, C5: 3, C6: 0, C7: 1 } },
  { id: 'A23', name: 'Susu Kedelai', emoji: '🥛', values: { C1: 5, C2: 3, C3: 5, C4: 5, C5: 4, C6: 1, C7: 2 } },
  { id: 'A24', name: 'Tomat', emoji: '🍅', values: { C1: 7, C2: 5, C3: 8, C4: 7, C5: 6, C6: 3, C7: 4 } },
  { id: 'A25', name: 'Beras Merah', emoji: '🍚', values: { C1: 4, C2: 7, C3: 6, C4: 5, C5: 6, C6: 1, C7: 2 } },
  { id: 'A26', name: 'Paprika', emoji: '🫑', values: { C1: 8, C2: 5, C3: 9, C4: 9, C5: 6, C6: 3, C7: 4 } },
  { id: 'A27', name: 'Kacang Hijau', emoji: '🥣', values: { C1: 5, C2: 7, C3: 6, C4: 4, C5: 5, C6: 1, C7: 1 } },
  { id: 'A28', name: 'Jamur', emoji: '🍄', values: { C1: 4, C2: 5, C3: 7, C4: 5, C5: 3, C6: 1, C7: 3 } },
  { id: 'A29', name: 'Gandum', emoji: '🍞', values: { C1: 6, C2: 6, C3: 5, C4: 5, C5: 7, C6: 3, C7: 3 } },
  { id: 'A30', name: 'Kacang Merah', emoji: '🫘', values: { C1: 8, C2: 8, C3: 7, C4: 8, C5: 7, C6: 3, C7: 4 } },
  { id: 'A31', name: 'Tuna', emoji: '🐟', values: { C1: 9, C2: 3, C3: 6, C4: 7, C5: 5, C6: 2, C7: 5 } },
  { id: 'A32', name: 'Kacang Kenari', emoji: '🥜', values: { C1: 5, C2: 6, C3: 6, C4: 8, C5: 6, C6: 3, C7: 2 } },
  { id: 'A33', name: 'Strawberi', emoji: '🍓', values: { C1: 2, C2: 6, C3: 9, C4: 7, C5: 5, C6: 0, C7: 1 } },
  { id: 'A34', name: 'Seledri', emoji: '🥬', values: { C1: 1, C2: 4, C3: 9, C4: 6, C5: 3, C6: 0, C7: 2 } },
  { id: 'A35', name: 'Chia Seeds', emoji: '🥄', values: { C1: 4, C2: 10, C3: 5, C4: 7, C5: 5, C6: 2, C7: 1 } },
  { id: 'A36', name: 'Biji Labu', emoji: '🎃', values: { C1: 5, C2: 7, C3: 8, C4: 6, C5: 6, C6: 2, C7: 3 } }
